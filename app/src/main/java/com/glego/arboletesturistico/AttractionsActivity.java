...
public class AttractionsActivity extends DrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = ListPlaces.attractionsValues(this);
        ...
        listView = (ListView) findViewById(R.id.list_view_attractions);
    ...
    protected String toolbarTitle() {
        return getString(R.string.tour_title);
    }
}